...
df = pd.read_csv('chennai_noise_2020_2024.csv')
...
plt.tight_layout()
plt.savefig('chennai_feature_importance.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('chennai_rf_cm.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.set_ylabel('Actual', fontsize=12)
plt.tight_layout()
plt.savefig('chennai_xgb_cm.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.spines['right'].set_visible(False)
plt.tight_layout()
plt.savefig('chennai_noise_trend.png', dpi=150, bbox_inches='tight')
plt.close()
...
ax.spines['right'].set_visible(False)
plt.tight_layout()
plt.savefig('chennai_zonewise_trend.png', dpi=150, bbox_inches='tight')
plt.close()
...
with open('chennai_locations_geo.json', 'w') as f:
